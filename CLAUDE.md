...
When both `index.mjml` and `index-emailify.mjml` exist in the repo, regenerate comparison images in these situations:
...
1. Compile both MJML files to HTML: `npx mjml index-emailify.mjml -o /tmp/original.html && npx mjml index.mjml -o /tmp/simple.html`
